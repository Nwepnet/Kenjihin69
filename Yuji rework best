...
fx5.Parent = game.Players.LocalPlayer.Character["Right Leg"]
...
fx6.Parent = game.Players.LocalPlayer.Character["Right Leg"]
...
local fx7 = game.ReplicatedStorage.Resources.FiveSeasonsFX["CharFX"].ArmFX:Clone()
fx7.Parent = game.Players.LocalPlayer.Character["Right Leg"]
for _, child in ipairs(fx7:GetChildren()) do
    if child:IsA("ParticleEmitter") then
        child.Color = aqua -- Change particle color to aqua
        child:Emit(20) -- Emit 1 particle
